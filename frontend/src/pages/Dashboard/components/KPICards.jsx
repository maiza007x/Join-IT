...
const KPICards = ({ data }) => {
  const stats = [
    ...
    { title: "งานที่ช่วยพี่ (Join)", value: data.joinTasks, icon: "pi-users", color: "text-blue-600", bg: "bg-blue-50" },
    { title: "งานที่ลุยเอง (Self)", value: data.selfTasks, icon: "pi-user", color: "text-emerald-600", bg: "bg-emerald-50" },
